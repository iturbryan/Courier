...
<div class="row">
  ...
  <h3>Edit Pricelist Item</h3>
	...
	?>
	  <option value="<?php echo $parcel_type->id; ?>" <?php if($parcel_type->id == $pricelist->parcel_type_id){?> selected="yes" <?php } ?>><?php echo $parcel_type->name; ?></option>
	<?php } ?>
	</select>
    </div>
	...
	?>
	  <option value="<?php echo $destination->id; ?>" <?php if($destination->id == $pricelist->source_id){?> selected="yes" <?php } ?>><?php echo $destination->name; ?></option>
	<?php } ?>
	</select>
    </div>
	...
	foreach($destinations->result() as $destination){
	?>
	  <option value="<?php echo $destination->id; ?>" <?php if($destination->id == $pricelist->destination_id){?> selected="yes" <?php } ?>><?php echo $destination->name; ?></option>
	<?php } ?>
	</select>
    </div>
    <div class="form-group col-xs-12">
      <label>Minimum Weight:</label>
      <input type="text" class="form-control input-sm" name="min_weight" value="<?php echo $pricelist->min_weight; ?>" />
    </div>
    <div class="form-group col-xs-12">
      <label>Amount:</label>
      <input type="text" class="form-control input-sm" name="amount" value="<?php echo $pricelist->amount; ?>">
    </div>
